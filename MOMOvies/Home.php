        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide container">
                ...
                <div class="home-text">
                    ...
                    <a href="Movie-landing.php?movie_id=1" class="btn">CHECK STORY</a>
                    <a href="server.php?movie_id=1" class="play">
            ...
            <div class="swiper-slide container">
                ...
                <div class="home-text">
                    ...
                    <a href="Movie-landing.php?movie_id=2" class="btn">CHECK STORY</a>
                    <a href="server.php?movie_id=2" class="play">
                        <i class='bx bx-play'></i>
                    </a>
                </div>
            </div>
    ...
    <section class="movies" >
        ...
        <div class="movies-container">
            ...
            <div class="box-img">
                ...
                <div class="overlay">
                    <a href="server.php?movie_id=8" class="btn1">PLAY</a>
                    <a href="Movie-landing.php?movie_id=8" class="btn2">MORE INFO</a>
                    <a href="" class="btn3">ADD TO WISHLIST</a>
                  </div>
            </div>
            <h3>The Hobbit</h3>
